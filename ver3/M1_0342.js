...
// Hide Cap2  Start
            ...
            function toggleCap2(trimValue) {
                if (trimValue == 1 || trimValue == 2 || trimValue == 4) {
                    // Ascundere capitol 1.2 dacă TRIM este 1, 2 sau 4
                    ...
                    // Deselectăm valorile din toate câmpurile CAEM pentru toate coloanele din CAP2
                    jQuery('select[name^="CAP2_CAEM"]').each(function () {
                        jQuery(this).val('');  // Setați valoarea la un string gol pentru a "deselecta"
                        jQuery(this).find('option:selected').prop('selected', false);  // Deselectează opțiunile selectate manual
                    });
