...
webform.validators.m1 = function (v, allowOverpass) {
    ...
    function validateCAEM_COL1_CAP1(values) {
        // Check if values is undefined and initialize it manually
        if (typeof values === 'undefined') {
            values = {};
        }

        // Retrieve CAEM from a form field with id='CAEM'
        values.CAEM = jQuery('#CAEM').val();  // Manually populating the values object

        console.log('Values object:', values);  // Now this should log the actual values

        var fields_CAP1_CAEM2 = jQuery('#CAP1 thead tr td:nth-child(2)').find('select').val();  // This part should work as expected
