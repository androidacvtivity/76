...
webform.validators.m1 = function (v, allowOverpass) {
    ...
    if (TRIM == 3) {
        ...
        // Check if CAP2_R10_C1 or CAP1_R120_C1 is zero to avoid division by zero
        if (CAP2_R10_C1 === 0 || CAP1_R120_C1 === 0) {
            webform.warnings.push({
                'fieldName': 'CAP2_R160_C1',
                'weight': 23,
                'msg': Drupal.t('Cod atenționare: 07-023 - Nu se poate efectua calculul deoarece Cap.2 R.10 Col.1 sau Cap.1 R.120 Col.1 este zero.')
            });
        } else {
       ...
       // CAP2_R160_C1 = 11
        ...
        //In this validation I have - msd - Rînd. 160 col.1 - Cod atenționare: 07-023 - (Cap.2 R.160 Col.1 * 1000 / R.10 Col.1) / Cap.1 R.120 Col.1 * 100 = [85-130]% -> [Infinity]%
