...
webform.validators.m1 = function (v, allowOverpass) {
    ...
    function validateCAEM_COL1_CAP1(values) {
        // Retrieve the value from the CAEM dropdown
         ...
         var fields_CAP1_CAEM2 = jQuery('#CAP1 thead tr td:nth-child(' + 2 + ')').find('select').val(); //This is corect 

        var fields_CAEM2 = values.CAEM; // After debuging is values - 'A0111' but CAEM is undefined and  // fields_CAEM2 is undedined  //This is incorect 
        ...
        if (fields_CAEM2 !== fields_CAP1_CAEM2) {  //In this case is values.CAEM = 
            // Push error if CAEM does not match
            webform.errors.push({
                'fieldName': 'CAP1_CAEM_C1', // Specific field causing the error
                'msg': Drupal.t(`Cod eroare: A.014 Cod CAEM (${fields_CAEM2}) trebuie sa fie acelasi ca si in Activitatea principală (${fields_CAP1_CAEM2})`)
            });
        }
    }
