...
webform.validators.m1 = function (v, allowOverpass) {
    ...
    function validateCAEM_COL1_CAP1(values) {
        ...
        // Use the Select2 API to retrieve the selected value from the CAEM dropdown
        values.CAEM = jQuery('#CAEM').select2('val');  // Correctly retrieve the value from the Select2 widget

        console.log('CAEM value:', values.CAEM);  // This should log the correct CAEM value

        // Retrieve the value from the other dropdown in the table
