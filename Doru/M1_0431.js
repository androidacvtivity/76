...
webform.validators.m1 = function (v, allowOverpass) {
    ...
    if (TRIM == 3) {
        ...
        var calcul8 = 0; // Initialize calcul8 as 0

        // Check if CAP2_R10_C1 or CAP1_R120_C1 is zero
        if (CAP2_R10_C1 !== 0 && CAP1_R120_C1 !== 0) {
            // Only perform the calculation if both values are non-zero
            calcul8 = (CAP2_R160_C1 * 1000 / CAP2_R10_C1) / CAP1_R120_C1 * 100;
            calcul8 = roundToDecimal(calcul8, 1);
        } else {
            // If either value is zero, calcul8 will remain 0
            calcul8 = 0;
        }
