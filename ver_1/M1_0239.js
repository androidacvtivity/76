...
//
            ...
            jQuery('select[name="TRIM"]').change(function () {
                ...
                if (trimValue == 1 || trimValue == 2 ||trimValue == 4) {
                    ...
                    jQuery('#header_cap_2').hide();  // Hide the header of chapter 1.2
                    jQuery('#CAP2').hide();       // Hide the table related to chapter 1.2
                    ...
                    jQuery('#header_cap_2').show();  // Show the header for Chapter 1.2
                    jQuery('#CAP2').show();       // Show the table related to chapter 1.2
