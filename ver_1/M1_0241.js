(function ($) {
    Drupal.behaviors.m1 = {
        attach: function (context, settings) {
            ...
            ////Analyze the excel file - Chapter 2 CAEM.
            //add this clear CAP2_CAEM
            ...
            jQuery('select[name="TRIM"]').change(function () {
                ...
                if (trimValue == 1 || trimValue == 2 ||trimValue == 4) {
                    ...
                    jQuery('input[name^="CAP2"]').val('');            // Clear text inputs

                    // Clear specific fields: CAP2_CAEM_C2 through CAP2_CAEM_C8
                    jQuery('#select2-CAP2_CAEM_C2-container').text('');   // Clear text from CAP2_CAEM_C2
                    jQuery('#select2-CAP2_CAEM_C3-container').text('');   // Clear text from CAP2_CAEM_C3
                    jQuery('#select2-CAP2_CAEM_C4-container').text('');   // Clear text from CAP2_CAEM_C4
                    jQuery('#select2-CAP2_CAEM_C5-container').text('');   // Clear text from CAP2_CAEM_C5
                    jQuery('#select2-CAP2_CAEM_C6-container').text('');   // Clear text from CAP2_CAEM_C6
                    jQuery('#select2-CAP2_CAEM_C7-container').text('');   // Clear text from CAP2_CAEM_C7
                    jQuery('#select2-CAP2_CAEM_C8-container').text('');   // Clear text from CAP2_CAEM_C8
                    ...
                    // Show Chapter 2 if TRIM is not 4
